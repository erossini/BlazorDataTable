	...
	public static class Utils
	{
		...
		public static string GetPropertyName<T>(Expression<Func<T, object>> property)
		{
			if (!(property.Body is MemberExpression memberExpression))
			{
				...
				{
					throw new Exception($"Expression is not a MemeberExpression: {ex.Message}");
				}
			}
		...
		public static Models.PagedResult<T> ApplyPaging<T>(this IQueryable<T> source, Pager pager)
		{
			...
			return new Models.PagedResult<T>(Queryable.Take<T>(Queryable.Skip<T>(source, count), pager.PageSize).ToList<T>(),
				pager.PageNumber, pager.PageSize, source.Count<T>(), pager.SortColumn, pager.SortDirection);
		}
		  ...
		  Pager pager)
		{
			...
			return new Models.PagedResult<T>(result, pager.PageNumber, pager.PageSize, source.Count<T>(),
				pager.SortColumn, pager.SortDirection);
		}
